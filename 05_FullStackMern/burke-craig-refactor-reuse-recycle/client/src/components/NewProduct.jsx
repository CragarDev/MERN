...
const NewProduct = props => {
  ...
  const handleSubmit = (e, poduct) => {
    console.log('Entering handleSubmit')
    console.log('e', e)
    console.log('product:', product)
    const { title, price, description } = e
    console.log('pulled from e: title, price, desc', title, price, description)
    // e.preventDefault()
    // const { product } = props
    // get product object from state
